...
INSERT INTO `products`(`id`,`name`, `brand`, `shortDescription`, `description`, `price`, `rating`, `picture`) VALUES 
...
INSERT INTO `product_project` (`productId`,`projectId` ) VALUES 
(1,29),
(2,29),
(3,29),
(4,29),
...
INSERT INTO `project_step`(`projectId`, `stepId`) VALUES 
(26, 30),
(27, 31),
(28, 32),
(29, 33),
...
INSERT INTO `keywords`(`word`, `id`) VALUES 
 ('meubles', 1),
 ('outils', 2),
 ('jardin', 3),
 ('salle de bain', 4),
